...
//            do
//            { 
//                DPDebug.Log("Press apropriate LETTER key to run demo or ESC to quit:");
...
//            } while (key.Key != ConsoleKey.Escape);
        ...
        { 
           ...
           DPDebug.Log("Press any key to RETURN ...");
//            Console.ReadKey();
        }
        ...
        private static void PrintMethodNames(MethodInfo[] methods)
        {
            for (int index = 0; index < methods.Length; index++)
            {
				...
				DPDebug.Log(keyChar+":"+ method.Name);
            }
        }
        ...
        public static void AbstractFactory()
        {
           ...
           DPDebug.Log(mercedesSportsCar.GetType().ToString());
...
//            Console.ReadKey();
        ...
        private static void FactoryMethod()
        {
            ...
            {
               DPDebug.Log(reader.GetType().ToString());
           ...
           DPDebug.Log(book.GetType().ToString());
//
//            Console.ReadKey();
        }
        ...
        private static void Prototype()
        {
           ...
           DPDebug.Log(sourcePrice +"|"+currentPrice);
